			...
			<div class="row flex-row h-100">
				<div class="col-12 my-auto">
					<div class="password-form mx-auto">
						...
						<h3>Get Verification Code From Email</h3>
						<?php
						...
						?>
						<form method="POST" action="<?php echo site_url('login/check_verification_code');?>">
							<div class="group material-input">
								<input type="text" required name="code" placeholder="Enter Here">
