      ...
      <div class="col-12">
        <div class="widget has-shadow">
          ...
          <div class="widget-body">
            <?php  echo form_open_multipart("admin/insertCategory", 'class="form"'); ?>
            <!--<form class="form-horizontal" enctype="" method="POST" action="<?php //echo site_url("admin/insertProduct");?>">-->  
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-9">
                  <input type="text" class="form-control" name="category" id="category" value="<?php echo set_value('category'); ?>">
