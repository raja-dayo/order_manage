...
<script type="text/javascript">
      ...
      $(document).ready(function(event) { 
        $('#form').submit(function() {
         /* if ($.trim($("#email").val()) === "" || $.trim($("#name").val()) === "" || $.trim($("#number").val()) === "" || $.trim($("#site").val()) === "" || $.trim($("#country").val()) === "" || $.trim($("#lname").val()) === "") {
          ...
          if($("#name").val()==="" || $("#lname").val()==="" || $("#number").val()==="" || $("#site").val()==="" || $("#country").val()==="")
          {
            if($("#name").val()==="")
            {
              $("#name_msg").html("Please Enter Your Name");  
      ...
      <div class="col-xl-12">
        ...
        <div class="widget has-shadow">
          ...
          <div class="widget-body">
            <form class="needs-validation" novalidate id="form" onsubmit="return myForm()" method="post" action="<?php echo site_url("admin/updateVender");?>">
              <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Name *</label>
                <div class="col-lg-5">
                  <input type="text" class="form-control" placeholder="Enter your name" id="name" name="name" value="<?php echo $result[0]['name'];?>">
               ...
               <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                  <input type="text" class="form-control" placeholder="Enter your name" id="lname" name="lname" value="<?php echo $result[0]['last_name'];?>">
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                  <div class="input-group">
                    <input type="email" class="form-control" placeholder="Enter your email" disabled="true" id="email" name="email" required value="<?php echo $result[0]['email'];?>">
             ...
             <!-- <div class="form-group row d-flex align-items-center mb-5">
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Phone number" id="number" name="number" value="<?php echo $result[0]['phone_number'];?>">
                  </div>
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                  <input type="url" class="form-control" id="site" name="site" value="<?php echo $result[0]['site'];?>">
