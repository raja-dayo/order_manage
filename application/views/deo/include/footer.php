...
<script src="<?php echo base_url()."assets/vendors/js/base/core.min.js"?>" type="text/javascript"></script>

<script src="<?php echo base_url()."assets/vendors/js/bootstrap-select/bootstrap-select.min.js"?>" type="text/javascript"></script>

<script src="<?php echo base_url()."assets/vendors/js/datatables/datatables.min.js"?>" type="text/javascript"></script>


<script src="<?php echo base_url()."assets/vendors/js/datatables/dataTables.buttons.min.js"?>" type="text/javascript"></script>


<script src="<?php echo base_url()."assets/vendors/js/datatables/jszip.min.js"?>" type="text/javascript"></script>


<script src="<?php echo base_url()."assets/vendors/js/datatables/buttons.html5.min.js"?>" type="text/javascript"></script>


<script src="<?php echo base_url()."assets/vendors/js/datatables/pdfmake.min.js"?>" type="text/javascript"></script>



<script src="<?php echo base_url()."assets/vendors/js/datatables/vfs_fonts.js"?>" type="text/javascript"></script>


<script src="<?php echo base_url()."assets/vendors/js/datatables/buttons.print.min.js"?>" type="text/javascript"></script>
...
<script src="<?php echo base_url()."assets/vendors/js/progress/circle-progress.min.js"?>" type="text/javascript"></script>
...
<script src="<?php echo base_url()."assets/js/components/tables/tables.js"?>" type="text/javascript"></script>
